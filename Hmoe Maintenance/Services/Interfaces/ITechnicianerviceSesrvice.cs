...
namespace Hmoe_Maintenance.Services.Interfaces
{
    ...
    {
        Task<PaginationResponse<ShowTechnicianServiceResponse,FilterTechnicianServiceResponse>> GetAllTechnicianService(FilterTechnicianServiceRequest filter, int page);
